...
# Add score helper once. Existing enrichment data already supplies salesFitScore;
# the browser-side fallback keeps older cached/localStorage leads usable.
...
# Add the sales-ready filter once.
...
# Small visual additions for the score badge.
