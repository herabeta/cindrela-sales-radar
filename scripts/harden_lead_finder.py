...
# Replace any existing contactable arrow function up to the next helper. This remains safe if
# a previous version used a different validation expression.
...
# Trigger daily enrichment after validation guard updates.
